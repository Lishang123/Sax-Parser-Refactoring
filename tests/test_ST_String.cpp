...
TEST_CASE("ST_String: copy of default-constructed is null-safe",
          "[String][st_string]") {
  ST_String a;
  ST_String b = a;
  CHECK(b.isEmpty());
...
TEST_CASE("ST_String: const char* string constructor is null-safe",
          "[String][st_string]") {
...
TEST_CASE("ST_String: const char* string constructor with empty string",
          "[String][st_string]") {
  ST_String s("");
  CHECK(s.isEmpty());
  CHECK(s.view().empty());
