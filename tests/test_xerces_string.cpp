...
TEST_CASE("XML_xerces_String: Default constructor with empty string",
          "[xml][xml-xerces-string]") {
  ensure_xerces();
...
TEST_CASE("XML_xerces_String: Construct from local form",
          "[xml][xml-xerces-string]") {
  ensure_xerces();
...
TEST_CASE("XML_xerces_String: Construct from XML form",
          "[xml][xml-xerces-string]") {
  ensure_xerces();
...
TEST_CASE("XML_xerces_String: Move constructor transfers ownership",
          "[xml][xml-xerces-string]") {
  ensure_xerces();
...
TEST_CASE("XML_xerces_String: Move assignment transfers ownership",
          "[xml][xml-xerces-string]") {
  ensure_xerces();
